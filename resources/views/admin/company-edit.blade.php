    ...
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('company.save') }}">
                ...
                <div class="form-floating mb-3">
                    <input id="contact" type="text" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact') ?? $company->contact }}" required autocomplete="contact" placeholder="Numer tel. kontaktowy" autofocus />
