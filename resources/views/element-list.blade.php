                ...
                <div class="col-md-6">
                    <div class="form-floating mt-4 mb-3 mb-md-0">
                        ...
                        <h5 class="text-center font-weight-light mb-md-0">
                          ...
                          <span class="badge text-dark mb-2"><a href="{{route('element.import')}}"><button class="btn btn-outline-link btn-sm" ><i class="far fa-file-alt grey700color"></i> <i class="fas fa-exchange-alt grey700color"></i> <i class="far fa-hdd grey700color"></i></button></a></span><br>
                        </h5>
