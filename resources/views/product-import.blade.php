...
<div class="col-lg-6">
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        ...
        <div class="card-body">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('product.upload') }}">
        ...
        <div class="card-footer py-3 muted">
            <small class="text-muted"><i class="fas fa-info-circle"></i> <strong>Schemat pliku</strong></small><h6 class="grey800color">Kod ; Nazwa</h6>
        </div>
    </div>
</div>
